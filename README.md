...
An example setup of a wireguard VPN hub and spoke setup. This is configured for the spokes to connect
...
The project configures them to forward traffice and installs and configures wireguard.
...
runs `stubby` for secure DNS over TLS. The default configuration uses cloudflare for this service; this can be overridden 
with variables.
...
can customise more by overrided any of the variables in `variables.tf`
